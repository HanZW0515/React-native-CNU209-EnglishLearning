...
var new_preTest3 = React.createClass({
    ...
    render(){
        if(this.state.result1 == 0) {var picture1 =(<Image source={{uri:this.state.pic1}} style={{width:200,height:200,marginTop:70}}/>)}
                    ...
                    <Image style={{height: 706}} resizeMode='cover' source={require('./../image/preTest/pretest_background.png') }>
                        ...
                        <View style = {styles. piccontainer}>
                            ...
                            <View style = {{alignItems: 'center', justifyContent: 'center',flex:1,flexDirection:'row'}}>
                                <Text onPress = {()=>this._clear()} style = {{fontSize:20,marginTop:100}}>重新输入</Text>
                            </View>
