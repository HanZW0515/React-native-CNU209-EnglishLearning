...
var transfer = require('./../test/test5');
...
var test4 = React.createClass({
    ...
    _handleResponse1(responseText) {
     ...
     //   var word = jonstr.result.data[0].content;
        ...
        var wordtemp='';
        if(length==3) wordtemp = '';
        else
        {
            for (var i = 3; i < length; i++){
                wordtemp=wordtemp+word[i]
            }
        }
                this.setState({
                    pic1: picture1,
    ...
    _wrong(){
        var hh = 'http://172.19.203.116:8080/iqasweb/mobile/pass/middletest.html?UserId=2141002035&TestKnowledgeId=' + this.state.word + '&TestType=1&TestAspect=3&TestDifficulty='
                            ...
                            <View style={styles.content_top}>
                                <Image style={{width: 800, height: 500, marginLeft:130}} resizeMode='stretch' source={require('./../image/test/dialogue_box.png') }>
                                    <View style={styles.content_text}>
                                        ...
                                        <Text style = {{fontSize:30}}>Can you complement words according to letters and picture ? </Text>
                                        <View style = {styles.piccontainer}>
                                            <View>
                                                {picture1}
                                                <View style = {{flexDirection : 'row',marginLeft:90}}>
                                                    <Text style={styles.textsty3}>{this.state.wordpiece1}</Text>
                                                    <TextInput
                                                        style={styles.inputsty}
                                                        onChangeText={(text) => this.setState({word:text})}
                                                        onSubmitEditing={()=>this._choose(1)}
                                                    />
                                                    <Text style={styles.textsty3}>{this.state.wordpiece2}</Text>
                                                </View>
                                            </View>
                                        </View>
