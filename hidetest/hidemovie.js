...
//主视图
var hidemovie = React.createClass({
                    ...
                    <Image style={{height: 706}} resizeMode='cover' source={require('./../image/preTest/pretest_background.png') }>
                        <View style={styles.content}>
                            ...
                            <View style={styles.content_top}>
                                <Text style={styles.content_text_type}>隐藏关1——我们一起学颜色！</Text>
                                        <Video source={{uri:'color'}} // Can be a URL or a local file.
