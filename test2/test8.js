...
'use strict';
var test8 = require('./../test/test8');
var React = require('react-native');
var transfer = require('./../test/test9')
...
var test8 = React.createClass({
    ...
    _choose(num) {
        switch(num) {
            case 1:
            {if(this.state.ans==this.state.word) {this.setState(
                {result1:1}
                            ...
                            <View style={styles.content_top}>
                                <Image style={{width: 800, height: 500, marginLeft:130}} resizeMode='stretch' source={require('./../image/test/dialogue_box.png') }>
                                    <View style={styles.content_text}>
                                        <Text style = {{fontSize:30,marginLeft: 30}}>Can you read the word ? </Text>
