...
'use strict';
var test14 = require('./../test/test14');
var React = require('react-native');
var transfer = require('./../test/test15')
...
var test14 = React.createClass({
    ...
    _right(){
        ...
        if (navigator) {
            navigator.push({
                name: 'transfer',
                component: require('./../test2/test15'),
                //这里多出了一个 params 其实来自于<Navigator 里的一个方法的参数...
                params: {
                    //user: JSON.stringify(this.state.user)
                    paramsUser: this.state.user,
    ...
    _choose(num) {
        switch(num) {
            case 1:
            {if(this.state.result==this.state.ans) {this.setState(
                {result1:1}
    ...
    render: function() {
        ...
        if(this.state.result2 == 1) {var text=(<Text style = {{fontSize:30,marginLeft: 30}}>Can you wirte the past tense of the word? </Text>)}
        if(this.state.result2 == 2) {var text=(<Text style = {{fontSize:30,marginLeft: 30}}>Can you wirte the plural forms of the word? </Text>)}
                                        ...
                                        <View style = {styles.piccontainer}>
                                            ...
                                            <View>
                                                <View style={styles.picsty3}>
                                                    <Text style={styles.textsty3}>{this.state.word}</Text>
                                                </View>
