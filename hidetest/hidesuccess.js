...
//主视图
var hidesuccess = React.createClass({
                            ...
                            <View style={styles.content_top}>
                                <Image style={{width: 700, height: 300}} resizeMode='stretch' source={require('./../image/preTest/dialogue_box.png') }>
                                    <View style={styles.content_text}>
                                        <Text style={styles.content_text_type}>Congratulations! </Text>
                                        <Text style={styles.content_text_type}>You get the new medal -- Day1 Medal!</Text>

                                        <View style={styles.content_botton}>

                                            <Image style={{width:80,height:110}} source={require('./../image/preTest/victory1.png') }/>
                                            {/*按钮：Go！*/}
                                            <TouchableHighlight
                                                style={styles.button}
                                                underlayColor='white'
