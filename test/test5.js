                                        ...
                                        <View style = {styles.piccontainer}>
                                            ...
                                            <View>
                                                ...
                                                <View style={styles.picsty3}>
                                                    <ImageButton source={require('./../image/test/ico_audio.png') } onPress={()=>sentance._stopRecognizing(this)} />
                                                    <ImageButton source={require('./../image/test/ico_reading.png') }  onPress={()=>sentance._startRecognizing(this)}/>
                                                </View>
