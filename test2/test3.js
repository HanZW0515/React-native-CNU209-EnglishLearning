...
var transfer = require('./../test/test4');
...
var test3 = React.createClass({
    ...
    _wrong(){
        var hh = 'http://172.19.203.116:8080/iqasweb/mobile/pass/middletest.html?UserId=2141002035&TestKnowledgeId=' + this.state.word + '&TestType=3&TestAspect=2&TestDifficulty='
