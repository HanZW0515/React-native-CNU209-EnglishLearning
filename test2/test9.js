...
'use strict';
var test9 = require('./../test/test9');
var React = require('react-native');
var transfer = require('./../test/test10')
...
var test9 = React.createClass({
    ...
    _right(){
        ...
        if (navigator) {
            navigator.push({
                name: 'transfer',
                component: require('./../test2/test10'),
                //这里多出了一个 params 其实来自于<Navigator 里的一个方法的参数...
                params: {
                    //user: JSON.stringify(this.state.user)
                    paramsUser: this.state.user,
    ...
    _final() {
        if(this.state.flag2==1&&this.state.flag3==1)
        {
            this.setState({
                result1:1
            });
    ...
    _choose(num){
        switch(num) {
            case 1:
            {if(this.state.ans==this.state.result) {this.setState(
                {flag3:1}
                                        ...
                                        <View style = {styles.piccontainer}>
                                            ...
                                            <View>
                                                <View style={styles.picsty3}>
                                                    <ImageButton source={require('./../image/test/ico_reading.png') } onPress={()=>this._right()} />
                                                </View>
